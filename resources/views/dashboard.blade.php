                ...
                <div class="p-6 text-gray-900">
                    <div class="w-full flex sm:flex-row flex-col justify-center sm:justify-start items-center mb-5">
                        <div class="sm:mb-0 mb-3">
                            <img class="inline-block lg:h-14 lg:w-14 h-12 w-12 lg:mx-10 mr-10 rounded-full" src="{{ isset(Auth::user()->profile_image) ? asset('storage/' . Auth::user()->profile_image) : asset('images/user_icon.png') }}" alt="" />
