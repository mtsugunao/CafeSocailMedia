<div x-data="{ 'showModal': false }" @keydown.escape="showModal = false">
    ...
    >
        <!-- Modal inner -->
        <div 
            class="max-w-5xl py-3 mx-auto text-left bg-white rounded shadow-lg relative w-full h-full md:w-5/6 md:h-4/5"
        ...
        >
            ...
            <div class="flex flex-col h-full">
                ...
                <!-- ボタンを一番下に固定 -->
                <button form="province" type="submit" class="w-full h-12 border border-green-500 bg-green-500 py-2.5 text-center text-xl font-medium text-white shadow-sm transition-all
