                ...
                <form action="{{ route('post.create.cafe', ['cafeId' => $cafe->id]) }}" method="post" id="post" enctype="multipart/form-data">
                    ...
                    <div class="p-3">
                        <div class="flex justify-between p-3 items-center">
                            ...
                            <p class="flex"><span class="length">255</span>&nbsp;words left</p>
                        </div>
                        <div class="pb-10 px-3">
                            ...
                            <x-post.form.images></x-post.form.images>
                            @error('post')
                    ...
                    <div class="md:hidden w-full flex items-center">
                        <button type="submit" class="justify-center mx-auto w-1/2 h-14 border border-lime-500 bg-lime-500 text-center text-xl font-medium text-white items-center rounded-lg shadow-sm transition-all
                    hover:border-lime-700 hover:bg-lime-700 focus:ring focus:ring-lime-200 disabled:cursor-not-allowed disabled:border-green-300 disabled:bg-lime-300">
                            Post
                        </button>
                    </div>
                </form>
            </div>
            <div class="hidden md:flex absolute bottom-4 w-full">
                <button form="post" type="submit" class="justify-center mx-auto w-1/2 h-16 border border-lime-500 bg-lime-500 text-center text-xl font-medium text-white items-center rounded-lg shadow-sm transition-all
                    hover:border-lime-700 hover:bg-lime-700 focus:ring focus:ring-lime-200 disabled:cursor-not-allowed disabled:border-green-300 disabled:bg-lime-300">
                    Post
                </button>
            </div>
