<div x-data="{ isOpen : false }">
  <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
    ...
    <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
      <li><a class="text-sm text-gray-400 hover:text-gray-500" href="{{ route('post.show') }}">Home</a></li>
      ...
      <li><a class="text-sm text-gray-400 hover:text-gray-500" href="{{ route('cafe.new') }}">Cafe Register</a></li>
      <li class="text-gray-300">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
        </svg>
      </li>
      <li><a class="text-sm text-gray-400 hover:text-gray-500" href="{{ route('post.posts') }}">Post</a></li>
      <li class="text-gray-300">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
        </svg>
  ...
  <div x-show="isOpen" class="relative z-50">
    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto" @click.away="isOpen = false">
      <div class="flex items-center mb-8 justify-between">
        ...
        <div class="h-full w-16">
          <a class="mr-auto text-3xl font-bold leading-none" href="{{ route('post.show') }}">
            <x-application-logo class="block fill-current text-gray-800" />
          </a>
        </div>
        @endauth
