...
<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-center">
    <span class="relative z-0 md:inline-flex shadow-sm rounded-md hidden">
        ...
        @else
        <a href="{{ $paginator->previousPageUrl() }}" rel="prev" class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-l-md leading-5 hover:text-black hover:bg-lime-100 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-lime-300 active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150" aria-label="{{ __('pagination.previous') }}">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
            </svg>
        </a>
        ...
        @else
        <a href="{{ $url }}" class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-black hover:bg-lime-100 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-lime-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150" aria-label="{{ __('Go to page :page', ['page' => $page]) }}">
            {{ $page }}
        </a>
        @endif
        @endforeach
        ...
        <a href="{{ $paginator->nextPageUrl() }}" rel="next" class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-r-md leading-5 hover:text-black hover:bg-lime-100 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-lime-300 active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150" aria-label="{{ __('pagination.next') }}">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
    ...
    <span class="relative z-0 inline-flex shadow-sm rounded-md md:hidden">
        ...
        @else
        <a href="{{ $paginator->previousPageUrl() }}" rel="prev" class="relative inline-flex items-center px-1 py-2 text-sm hover:bg-lime-100 hover:text-black font-medium text-gray-500 bg-white border border-gray-300 rounded-l-md leading-5 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-lime-300 active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150" aria-label="{{ __('pagination.previous') }}">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
            </svg>
        </a>
        ...
        <a href="{{ $paginator->url(1) }}" class="relative inline-flex items-center px-3 py-2 -ml-px text-sm font-medium text-success bg-white border border-gray-300 leading-5 hover:text-black hover:bg-lime-100 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-lime-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150" aria-label="{{ __('Go to page :page', ['page' => 1]) }}">
            1
        </a>
        @endif
        ...
        @if($i >= $paginator->currentPage() - 1 && $i <= $paginator->currentPage() + 1)
            ...
            @else
            <a href="{{ $paginator->url($i) }}" class="relative inline-flex items-center px-3 py-2 -ml-px text-sm font-medium text-success bg-white hover:bg-lime-100 border border-gray-300 leading-5 hover:text-black focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-lime-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150" aria-label="{{ __('Go to page :page', ['page' => $i]) }}">
                {{ $i }}
            </a>
            @endif
            @endif
